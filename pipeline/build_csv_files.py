...
# generat the directory in which the final csv files will be saved.
...
for file in relevant_files:
    ...
    for file_i, curr_file in enumerate(res_files):
        ...
        curr_file_data = pd.read_csv(os.path.join(res_data_path, curr_file), sep=r'\s+', header=None, names=['read_num', 'seq'])
        read_counts = []
